...
public class JwtService {
    private static final String SECRET_KEY = "MAKAIABOOTCAMPFLIGHTRESERVATIONSYSTEMV112112023JMONTOYA";
    ...
    private String getToken(HashMap<String, Object> extraClaims, UserDetails user) {
        System.out.println(new Date(System.currentTimeMillis() + TimeUnit.HOURS.toMillis(1)));
        return Jwts.
                builder()
